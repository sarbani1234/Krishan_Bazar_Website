...
$cimages=md5($imgs).time().$extension;
 move_uploaded_file($_FILES["cimages"]["tmp_name"],"images/".$cimages);
    $ret=mysqli_query($con, "select Email from tblcustomer where Email='$email' || MobileNumber='$mobno'");
    $result=mysqli_fetch_array($ret);
    if($result>0){
$msg="This email or Contact Number already associated with another account";
    }
    else{
    $query=mysqli_query($con, "insert into tblcustomer(FullName,Email,MobileNumber,Gender,Address,City,Pincode,Images,Password) value('$fullname','$email','$mobno','$gender','$addr','$city','$pincode','$cimages','$password')");
    if ($query) {
...
<input style="position: absolute;top: 200px;left: 30%;border: solid silver;border-radius: 5px;font-family: cursive;color: grey;font-size: 20px;box-sizing: border-box;width: 40%;height: 50px;" type="email" name="email" id="email" placeholder="Enter your email" required="true">
                                    ...
                                    <input style="position: absolute;top: 350px;left: 30%;border: solid silver;border-radius: 5px;font-family: cursive;color: grey;font-size: 20px;box-sizing: border-box;width: 40%;height: 50px;" type="text" name="mobilenumber" required="true" placeholder="Enter Your Mobile Number" maxlength="10" pattern="[0-9]+">
                               
                                    <input style="position: absolute;top: 420px;left: 30%;border: solid silver;border-radius: 5px;font-family: cursive;color: grey;font-size: 20px;box-sizing: border-box;width: 40%;height: 50px;" type="text" name="tid" required="true" placeholder="Enter Customer ID">
                                </div>
                            </div>
              ...
              <input type="radio" name="gender" id="gender" value="Male"><strong style="color: grey">Male</strong>
                                    ...
                                    <input style="position: absolute;top: 900px;left: 30%;border: solid silver;border-radius: 5px;font-family: cursive;color: grey;font-size: 20px;box-sizing: border-box;width: 40%;height: 50px;" type="text" name="pincode" required="true" 
                                    ...
                                    <input style="position: absolute;top: 1000px;left: 30%;border: solid silver;border-radius: 5px;font-family: cursive;color: grey;font-size: 20px;box-sizing: border-box;width: 40%;height: 50px;" type="file" name="cimages" required="true"  title="Images" autocomplete="off">
                                
                           
                              
                                    <input style="position: absolute;top: 1100px;left: 30%;border: solid silver;border-radius: 5px;font-family: cursive;color: grey;font-size: 20px;box-sizing: border-box;width: 40%;height: 50px;" type="password" name="password" required="true" 
                                           placeholder="Enter your Password" autocomplete="off">
                               
                                    <input style="position: absolute;top: 1200px;left: 30%;border: solid silver;border-radius: 5px;font-family: cursive;color: grey;font-size: 20px;box-sizing: border-box;width: 40%;height: 50px;" type="password" name="password" required="true" 
                                           placeholder="Re-enter your Password" autocomplete="off">
                              
                           
                           
                           
                             <button style="position: absolute;top: 1350px;left: 30%;" class="fill" type="submit" name="submit" value="Register">Create Account</button>

    <a class="accountcr" style="position: absolute;top: 1350px;left: 48%;" href="login.php"> Already Have an Account ? </a>

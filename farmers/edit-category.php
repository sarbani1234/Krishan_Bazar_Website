...
$query=mysqli_query($con,"update tblcategory set CategoryName='$catname',CategoryId='$catcode' where ID='$cid'"); 
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['CategoryName'];?>" name="category" required autocomplete="off">
<div>Please provide a valid category name.</div>
...
<input type="text" class="form-control" id="validationCustom03" value="<?php echo $row['CategoryId'];?>" name="categoryid" required autocomplete="off">
<div class="invalid-feedback">Please provide a valid category code.</div>


<?php } ?>                                 
<button style="position: absolute;top: 200px;left: 50%;" class="fill" type="submit" name="update">Update</button>
</div>
</form>
<!--footer starts here-->

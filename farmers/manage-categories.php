...
?>
 ...
 <div style="position: absolute;top: 400px;left: 100px;">
                                        ...
                                        <table border="1">
                                            ...
                                            <tbody>
<?php
if(isset($_SESSION["agrouid"])){
$rno=mt_rand(10000,99999);  
$query=mysqli_query($con,"select * from tblcategory where FarmerName='$fname' order  by  ID");
...
<td>
<a href="edit-category.php?catid=<?php echo base64_encode($row['ID'].$rno);?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit">Edit</a>
<a href="manage-categories.php?del=<?php echo base64_encode($row['ID'].$rno);?>" data-toggle="tooltip" data-original-title="Delete" onclick="return confirm('Do you really want to delete?');"><i class="fa fa-trash-o"></i>Delete</a>
</td>
</tr>
<?php 
$cnt++;
}}  else {
    echo "<script>alert('You have not uploaded any category yet!!')</script>"; 
}} ?>

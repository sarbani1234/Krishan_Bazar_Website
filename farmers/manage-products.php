...
$query=mysqli_query($con,"select * from tblproducts where FarmerName='$fname' order  by  ID");
...
<td>
<a href="edit-product.php?pid=<?php echo base64_encode($row['ID'].$rno);?>" class="mr-25" data-toggle="tooltip" data-original-title="Edit">Edit</a>
</td>
</tr>
<?php 
$cnt++;
}} else {
    echo "<script>alert('You have not uploaded any products yet!!')</script>"; 
}} ?>

...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    move_uploaded_file($filetmp, $destination);
       ...
       $result= mysqli_query($conn,"INSERT INTO `cab` (`Id`, `Model`, `Company`, `Description`, `File`,`Type`,`Email`,`DateTime`) VALUES ('$Id', '$Model', '$Company', '$Description', '$destination','$type','$Email',current_timestamp())");
          if($result)
          {
           $insertalert=true;
          }
        ...
        <form action="addcab.php" method="post" enctype="multipart/form-data">
          <div class="container">
            ...
            <div class="container row my-4">
              ...
              <div class="col">
                <font color="grey" >Design: &nbsp &nbsp</font>

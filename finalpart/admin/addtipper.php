...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    if(isset($_POST['snoEdit']))
        {
          ...
          $result=mysqli_query($conn,"UPDATE `tipper` SET `Id` = '$Id', `Model` = '$Model', `Company` = '$Company', `Description` = '$Description' WHERE `tipper`.`Sno` = '$sid'");
          if($result)
          {
    ...
    move_uploaded_file($filetmp, $destination);
       ...
       $result= mysqli_query($conn,"INSERT INTO `tipper` (`Id`, `Model`, `Company`, `Description`, `File`,`Type`,`Email`, `DateTime`) VALUES ('$Id', '$Model', '$Company', '$Description', '$destination','$type','$Email', current_timestamp())");
          if($result)
          {
           $insertalert=true;
          }
...
<html lang="en">
  ...
  <body>
    ...
    {
      $sid=$_GET['eid'];
      $sql="SELECT * FROM `tipper` WHERE Sno=$sid";
...
while($row=mysqli_fetch_assoc($result))
{
    ...
    <form action="addtipper.php?sno='.$sid.'" method="post" enctype="multipart/form-data">
...
else
{
  ...
  <div class="container mt-3">
        ...
        <form action="addtipper.php" method="post" enctype="multipart/form-data">
          <div class="container">
            <div class="container row my-4">
              <div class="col">

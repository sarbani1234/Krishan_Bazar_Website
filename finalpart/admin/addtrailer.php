...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    if(isset($_POST['snoEdit']))
        {
          ...
          $result=mysqli_query($conn," UPDATE `trailer` SET `Model` = '$Model', `Company` = '$Company', `Description` = '$Description', `Id` = '$Id' WHERE `trailer`.`Sno` = '$sid'");
          if($result)
          {
            header("location:card.php?tid=2");
          }
      }
    else
    {
    ...
    move_uploaded_file($filetmp, $destination);
       ...
       $result= mysqli_query($conn,"INSERT INTO `trailer` (`Id`, `Model`, `Company`, `Description`, `File`,`Type`,`Email`, `DateTime`) VALUES ('$Id', '$Model', '$Company', '$Description', '$destination','$type','$Email', current_timestamp())");
          if($result)
          {
           $insertalert=true;
          }
...
<html lang="en">
  ...
  <body>
    ...
    {
      $sid=$_GET['eid'];
      $sql="SELECT * FROM `trailer` WHERE Sno=$sid";
...
while($row=mysqli_fetch_assoc($result))
{
    ...
    <form action="addtrailer.php?sno='.$sid.'" method="post" enctype="multipart/form-data">
...
else
{
  ...
  <div class="container mt-3">
        ...
        <form action="addtrailer.php" method="post" enctype="multipart/form-data">
          <div class="container">
            <div class="container row my-4">
              <div class="col">

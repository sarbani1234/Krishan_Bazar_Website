...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    if(isset($_POST['snoEdit']))
        {
          ...
          $result=mysqli_query($conn,"UPDATE `trailercab` SET `Id` = '$Id', `Model` = '$Model', `Company` = '$Company', `Description` = '$Description' WHERE `trailercab`.`Sno` = '$sid'");
          if($result)
          {
            header("location:card.php?tid=3");
          }
      }
    else
    {
    ...
    move_uploaded_file($filetmp, $destination);
       ...
       $result= mysqli_query($conn,"INSERT INTO `trailercab` (`Id`, `Model`, `Company`, `Description`, `File`,`Type`,`Email`, `DateTime`) VALUES ('$Id', '$Model', '$Company', '$Description', '$destination','$type','$Email',current_timestamp())");
          if($result)
          {
           $insertalert=true;
          }
...
<html lang="en">
  ...
  <body>
    ...
    if($insertalert)
    {
        ...
        <strong>Success!</strong> Details added sucessfully
    ...
    {
      $sid=$_GET['eid'];
       $sql="SELECT * FROM `trailercab` WHERE Sno=$sid";
...
while($row=mysqli_fetch_assoc($result))
{
  ...
  $description=$row['Description'];
    ...
    <form action="addtrailercab.php?sno='.$sid.'" method="post" enctype="multipart/form-data">
...
else
{
  ...
  <div class="container mt-3">
        ...
        <form action="addtrailercab.php" method="post" enctype="multipart/form-data">
          <div class="container">
            <div class="container row my-4">
              <div class="col">
            ...
            <div class="container row my-4">
              ...
              <div class="col">
                <font color="grey" >Vehicle Type: &nbsp &nbsp</font>
        <select name="category" class="btn-lg">

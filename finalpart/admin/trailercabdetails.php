...
{
    $sno=$_GET['snoid'];
    $sql="DELETE FROM `trailercab` WHERE `trailercab`.`Sno` = $sno";
...
$id=$_GET['catid'];
$sql="SELECT * FROM `trailercab` WHERE Sno=$id";
$result=mysqli_query($conn, $sql);
      ...
      <div class="row">
        <div class="col" align="left"><h2><b><?php
           ...
           <?php
            ...
            ?></h6>
             <div class="col">
             <?php echo '<a class=" edit btn btn-primary my-3" href="addtrailercab.php?eid='.$sno.'" role="button" >Edit Detail</a>
             <a class=" delete btn btn-primary my-3" href="trailercabdetails.php?snoid='.$sno.'" role="button" >Delete Detail</a>';?>
           </div> 
        </div>

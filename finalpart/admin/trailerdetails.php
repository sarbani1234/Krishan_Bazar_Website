...
{
    $sno=$_GET['snoid'];
    $sql="DELETE FROM `trailer` WHERE `trailer`.`Sno` = $sno";
...
$id=$_GET['catid'];
$sql="SELECT * FROM `trailer` WHERE Sno=$id";
$result=mysqli_query($conn, $sql);
      ...
      <div class="row">
        <div class="col" align="left"><h2><b><?php
           ...
           <?php
            ...
            ?></h6>
             <div class="col">
             <?php echo '<a class=" edit btn btn-primary my-3" href="addtrailer.php?eid='.$sno.'" role="button" >Edit Detail</a>
             <a class=" delete btn btn-primary my-3" href="trailerdetails.php?snoid='.$sno.'" role="button" >Delete Detail</a>';?>
           </div> 
        </div>

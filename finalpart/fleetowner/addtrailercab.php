...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    move_uploaded_file($filetmp, $destination);
       ...
       $result= mysqli_query($conn,"INSERT INTO `waiting` (`Id`, `Model`, `Company`, `Description`, `File`, `Type`, `vehicle`, `Email`, `DateTime`) VALUES ('$Id', '$Model', '$Company', '$Description', '$destination', '$type', 'trailercab', '$Email', current_timestamp())");
          if($result)
          {
           $insertalert=true;
          }

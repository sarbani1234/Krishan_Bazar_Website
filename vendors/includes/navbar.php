     <nav class="navbar navbar-expand-xl navbar-light fixed-top hk-navbar">
            <a id="navbar_toggle_btn" class="navbar-toggle-btn nav-link-hover" href="javascript:void(0);"></a>
            <a class="navbar-brand" href="dashboard.php">KRISHAN BAZAR WEBSITE
            </a>
            
<?php
$vid=$_SESSION['agrovid'];
$ret=mysqli_query($con,"select CompanyName,Images from tblvendor where ID='$vid'");

...
$query=mysqli_query($con,"select distinct Invoice_No,name,email,city,state,zip,mobile_no,address,InvoiceGenDate  from vendor_bill  where Invoice_No='$inid'");
$cnt=1;
...
<span style="font-size:20px;"><b>Vendor#  </b><span><?php echo $row['name'];?></span></span><br><br>
<span style="font-size:20px;"><b>Vendor Mobile No #  </b><span><?php echo $row['mobile_no'];?></span></span><br><br>
...
<th style="font-size:20px;" width="10%">Price</th>
                                            ...
                                            <tbody>
<?php 
$query=mysqli_query($con,"SELECT tblproducts.CategoryName,tblproducts.ProductName,tblproducts.ProductQuantity,tblproducts.ProductPrice,vendor_bill.Quantity FROM vendor_bill JOIN tblproducts ON tblproducts.ID=vendor_bill.ProductId WHERE vendor_bill.Invoice_No='$inid'");
$cnt=1;
while($row=mysqli_fetch_array($query))
{ 

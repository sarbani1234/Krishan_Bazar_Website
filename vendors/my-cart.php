...
<li class="breadcrumb-item active" aria-current="page">My Cart</li>
    ...
    <form class="needs-validation" action="cart_process.php" method="post" novalidate>
...
$ret=mysqli_query($con,"select FullName from tblvendor where ID='$_SESSION[agrovid]'");
while($row=mysqli_fetch_array($ret))
{?>
<input type="text" class="form-control" id="validationCustom03" placeholder="Your name" name="vendorname" value="<?php echo $row['FullName'];?>" required autocomplete="off">
<?php } } ?> <br> <br>
